...
import nl.oxborrow.spark.security.interceptors.SecuredInterceptor;
...
public class AnnotationModule extends AbstractModule {
    ...
    protected void configure() {
        bindInterceptor(Matchers.any(), Matchers.annotatedWith(Secured.class), new SecuredInterceptor());
    }
}
